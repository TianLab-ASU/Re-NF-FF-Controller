clc
clear
%% Tuning uI for optimizing the performance of Re-NF-FF, a=1, Roff=0.5;
...
subplot(2,2,2)
barh(uI0, Coupling_index) 
subplot(2,2,1)
RFP_Sim=0:0.01:1;
imagesc( RFP_Sim, uI0, GFP_Sim)
set(gca, 'ydir','normal')
...
hold on
%% Find the optimal uI value
uI0_for_min_CI=interp1(Coupling_index,uI0,0) 
j=101;
a=1; 
Roff=0.5;
uI=uI0_for_min_CI
